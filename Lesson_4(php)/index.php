...
$skills = [
 ...
 $workExperience = [
     [
        ...
        'data' => 'Jan 2015 -',
        'text' => 'Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
        ...
        'text' => 'Consectetur adipisicing elit. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
                            sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.',
         ],
         [
        'position' => 'Graphic Designer / designsomething.com',
        'data' => 'Jun 2010 - Mar 201',
            ...
            <div class="w3-twothird">
                <div class="w3-container w3-card w3-white w3-margin-bottom">
                    ...
                    <div class="w3-container">
                        ...
                        <h5 class="w3-opacity"><b><?php echo $workExperience[$i]["position"]; ?> </b></h5>
                        <?php if ($workExperience[$i]["position"] == "Front End Developer") : ?> 
                         <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $workExperience[$i]["data"]; ?>
                        <span class="w3-tag w3-teal w3-round">Current</span></h6>
                        <?php else : ?>
                        <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $workExperience[$i]["data"]; ?></h6> 
                       <?php endif; ?>
                        <p><?php echo $workExperience[$i]["text"]; ?></p>
                        <hr>
                          <?php endfor; ?><br>
                    </div>
